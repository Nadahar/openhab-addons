...
public interface Job extends SchedulerRunnable, Runnable {
     ...
     */
    static void schedule(AstroThingHandler astroHandler, String identifier, Job job, Calendar eventAt, TimeZone zone, Locale locale) {
        try {
     ...
     * @param locale the configured locale
     */
    static void schedulePublishPlanet(AstroThingHandler astroHandler, String identifier, Calendar eventAt, TimeZone zone, Locale locale) {
     ...
     * @param eventAt the {@link Calendar} instance denoting scheduled instant
     */
    static void scheduleSunPhase(AstroThingHandler astroHandler, String identifier, SunPhaseName sunPhaseName, Calendar eventAt,
